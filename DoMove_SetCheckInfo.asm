...
DoMove_SetCheckInfo:
		...
		;     edx  move is check
			...
			mov   r13, qword [rbx+State.materialKey]
		      _movq   xmm0, qword [rbx+State.psq]	; psq and npMaterial
...
.ResetEpRet:
	...
	; move piece
			...
			xor   rdx, qword [Zobrist_Pieces+r10+8*r9]
		      _movd   xmm1, dword [Scores_Pieces+r10+8*r8]
		      _movd   xmm2, dword [Scores_Pieces+r10+8*r9]
			xor   r15, rdx
			and   rax, rdx
			xor   r14, rax
		     _psubw   xmm0, xmm0, xmm1
		     _paddw   xmm0, xmm0, xmm2
			shr   r10d, 6+3
...
.Capture:
	...
	; remove piece
			...
			xor   r13, qword [Zobrist_Pieces+r11+8*rdi]
		      _movq   xmm1, qword [Scores_Pieces+r11+8*r9]
		     _psubw   xmm0, xmm0, xmm1
			shr   r11d, 6+3
			jmp   .CaptureRet
...
.Promotion:
		...
		; remove pawn r10 on square r9
			...
			xor   r13, qword [Zobrist_Pieces+r10+8*rax]
		      _movd   xmm1, dword [Scores_Pieces+r10+8*r9]
		     _psubw   xmm0, xmm0, xmm1
		; place piece ecx on square r9
			...
			xor   r13, qword [Zobrist_Pieces+rcx+8*(rax-1)]
		      _movd   xmm1, dword [Scores_Pieces+rcx+8*r9]
...
.EpCapture:
	; remove pawn r10^8 on sqare ecx=r9+8*(2*esi-1)
			...
			xor   r13, qword [Zobrist_Pieces+r10+8*rdi]
		      _movq   xmm1, qword [Scores_Pieces+r10+8*rcx]
		     _psubw   xmm0, xmm0, xmm1
			xor   esi, 1
			jmp   .SpecialRet
