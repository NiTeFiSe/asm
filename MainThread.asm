...
_ZN10MainThread9idle_loopEv:
	; rcx: address of mainThread
			...
			mov   rbx, rcx
		 DebugPrint   '_ZN10MainThread9idle_loopEv start'
._006:
			mov   rcx, rsi
		       call   _MutexLock
...
._007:
			...
			mov   rcx, qword [threadPool+ThreadPool.sleepCondition]
		       call   _EventSignal
		 DebugPrint   '_ZN10MainThread9idle_loopEv before wait'
			mov   rdx, rsi
			mov   rcx, rdi
		       call   _EventWait
		 DebugPrint   '_ZN10MainThread9idle_loopEv after wait'
			jmp   ._007
._008:
			mov   rcx, rsi
		       call   _MutexUnlock
			...
			jmp   ._006
._009:
		 DebugPrint   '_ZN10MainThread9idle_loopEv end'
			pop   rbx rsi rdi
			ret
